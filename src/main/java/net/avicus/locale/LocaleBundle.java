package net.avicus.locale;

import java.util.ArrayList;
import java.util.List;
import java.util.Locale;
import java.util.Optional;
import net.avicus.locale.text.Localizable;
import net.avicus.locale.text.LocalizedFormat;
import net.avicus.locale.text.LocalizedText;
